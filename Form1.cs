    ...
    public partial class mainForm : Form
    {
        ...
        private void btn_Start_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                txtBox_history.AppendText(txtBox_FileLoc.Text);
        ...
        private void txtBox_FileLoc_DragOver(object sender, DragEventArgs e)
        {
        ...
        private void txtBox_FileLoc_DragDrop(object sender, DragEventArgs e)
        {
            string[] files = (string[])e.Data.GetData(DataFormats.FileDrop);
            if (files != null && files.Length != 0)
            {
                txtBox_FileLoc.Text = files[0];
            }
        }
    }
}
